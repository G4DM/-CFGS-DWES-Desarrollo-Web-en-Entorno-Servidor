...
<form name="formBusqueda" action="index.php?ctl=buscarAlimentosCombinada" method="post">
    ...
    <input type="text" name="nombre" id="nombre" value="<?php echo $params['nombre'] ?>" required>
	<span>(puedes utilizar '%' como comodin)</span>
	<label for="energia">Energía alimento:</label>
	<input type="text" name="energia" id="energia" value="<?php echo $params['energia'] ?>" required>
	<span>(puedes utilizar '%' como comodin)</span>
